...
export const stories: Story[] = [
  ...
  },
  {
    ...
    tags: ["Trip Planning", "Culture"],
    author: editorialTeam,
    excerpt: "What's actually worth buying in Egypt's markets, and what to skip — spices, copperware, cotton, papyrus, and alabaster, and how to tell the good from the mass-produced.",
    imageLabel: "Khan el-Khalili",
    imageTone: "giza",
    ...
    relatedTours: toursBySlug("khan-el-khalili-food-walking-tour", "aswan-nubian-village-philae-tour", "6-day-cairo-giza-luxor", "8-day-essential-egypt-nile-cruise"),
    seoTitle: "What to Buy in Egypt: A Real Souvenir Shopping Guide",
    seoDescription: "What's genuinely worth buying in Egypt's markets — spices, copperware, cotton, papyrus, and alabaster — and how to tell the good stuff from the mass-produced.",
    body: [
      p("Every trip to Egypt ends with the same question crowding the last few days: what do you actually bring home. The markets pull you in with sheer variety — spice stalls stacked shoulder to shoulder with hammered copper lamps, alabaster carvings, rolled papyrus, and rack after rack of cotton scarves — and it's easy to leave with either too little, because you didn't trust your own instincts, or a suitcase full of things that looked better under bazaar lighting than they do on a shelf back home."),
      p("This is a practical rundown of what's genuinely worth the shopping, the packing space, and the negotiation, and what's worth walking past, based on what actually holds up once you're home."),
      h2("Spices, Herbs, and Teas"),
      p("Egypt's spice trade is centuries old, and the quality reaching the market stalls — especially in Cairo and Aswan — is often better than what's sold in supermarkets back home, at a noticeably lower price. Look for saffron (though treat very cheap saffron with suspicion; real saffron is never the least expensive option on the table), dukkah, cumin, and whole spice blends sold loose by weight rather than pre-bagged for tourists near the market entrance. A vendor worth buying from will let you smell what you're getting before you commit."),
      p("Karkade — dried hibiscus flowers, steeped into the cold ruby-red tea served everywhere in Egypt — deserves particular mention. It's inexpensive, packs light, doesn't spoil, and makes a drink that's genuinely part of Egyptian daily life rather than a tourist invention. A bag of good karkade is one of the easiest, most authentic things to bring home, and it costs almost nothing to try."),
      h2("Egyptian Cotton and Textiles"),
      p("Egypt has one of the world's great cotton-growing traditions, and it shows in the textiles sold across the markets — genuinely high-quality sheets, scarves, and galabeyas (the loose traditional garment worn across the country) at a fraction of what equivalent Egyptian cotton costs in Western department stores. Quality varies enormously between stalls, though, so it's worth handling the fabric before buying. Good Egyptian cotton feels dense and slightly cool against the skin, not thin or synthetic."),
      p("Handwoven scarves and shawls, particularly the ones coming out of workshops in Upper Egypt, are another strong option. Ask directly whether a piece is handwoven or machine-made — a good vendor will show you the difference in the weave without hesitation, and the gap in both feel and price is usually obvious once it's pointed out."),
      h2("Silver and Cartouche Jewelry"),
      p("A cartouche pendant — your name (or a name you choose) spelled out in hieroglyphs inside the oval frame that ancient Egyptian royalty used to enclose their own names — is one of the more personal souvenirs available, and reputable jewelers in Cairo, Luxor, and Aswan will translate and engrave one while you wait. Ask about the silver content before buying; sterling silver pieces are stamped, and a jeweler unwilling to show you the stamp is worth being cautious with. Prices vary with weight and chain length, so it's worth comparing a couple of shops before committing to one."),
      h2("Copper, Brass, and Hand-Hammered Metalwork"),
      p("Khan el-Khalili's coppersmiths still hand-hammer trays, lamps, and vessels the way their predecessors did generations ago, and it's worth seeking out the workshops tucked behind the main market alleys rather than buying from the front-facing stalls, where prices for identical work tend to run higher simply because of foot traffic. A well-made hammered copper tray or a brass lantern travels surprisingly well if it's wrapped properly for the flight home, and it's one of the rare souvenirs that looks even better on a shelf at home, freshly polished and catching lamplight, than it did in the bazaar."),
      h2("Papyrus, Carefully Sourced"),
      p("Papyrus art is one of the most tourist-saturated souvenirs in Egypt, which also makes it one of the easiest to get wrong. A large share of what's sold on the street and at tour-bus stops isn't actually papyrus at all — it's banana leaf or another substitute, printed with a design that won't hold up over years the way genuine papyrus does. Buying from a reputable workshop, ideally one where you can see the plant itself being processed into sheets, is worth the modest premium over a street stall."),
      callout("A trustworthy papyrus seller will happily show you the difference — how real papyrus reacts to light and how the fibers cross in a visible weave, versus a printed substitute that looks flat and uniform by comparison. If a seller gets evasive when you ask directly whether it's genuine, that's a fair reason to walk.", { title: "How to Spot Real Papyrus", tone: "Info" }),
      h2("Alabaster and Stone Carving"),
      p("Around Luxor and Aswan, alabaster carving is a real local craft, sold in everything from small scarab figures to full vases and canopic-jar replicas. Genuine hand-carved alabaster has a soft, slightly uneven translucence when held up to light; heavier, machine-cast pieces — sometimes marketed as alabaster but actually resin or plaster — feel colder and more uniform in both texture and weight. Weight itself is often a useful tell: hand-carved stone is noticeably heavier than a resin piece of the same size."),
      h2("What to Skip"),
      ...bullets([
        "Mass-produced \"ancient Egypt\" statuettes stamped from a mold — fine as a cheap keepsake, not worth paying craft prices for",
        "Anything sold to you as an actual antiquity — genuine antiquities cannot legally leave Egypt, and anyone offering to sell you one is either lying or asking you to take part in something you don't want to be involved in",
        "Pre-packaged spice sets aimed squarely at the tour-bus crowd, usually priced well above what the same spices cost loose",
        "Cheap glass perfume bottles sold as pure \"essential oil\" outside a licensed perfumery — the good ones exist, but they're not the ones flagged down on the street",
      ]),
      h2("Negotiating Without the Stress"),
      p("Negotiation is the norm in nearly every souvenir market in Egypt, and it isn't rude — it's simply how prices work here. Starting an offer well below the asking price is expected, not insulting, and a little back-and-forth is part of the transaction rather than a sign it's going badly. Don't be afraid to walk away if a price doesn't feel right; a genuinely final offer has a way of appearing the moment you turn toward the next stall. Fixed-price shops, more common among Cairo's larger papyrus houses and perfumeries, are a perfectly good option for anyone who'd rather skip the negotiation entirely."),
      h2("Getting It Home in One Piece"),
      p("Fragile items — alabaster, ceramics, glass perfume bottles — travel best wrapped in clothing inside checked luggage rather than trusting bazaar packing paper to survive a flight and baggage handling. Papyrus travels safely rolled inside a protective tube, which most reputable workshops will provide or sell for a small amount. For anything you're unsure about at customs — particularly a piece that looks old, even if it's a modern reproduction — it's worth asking the seller for a receipt or a simple certificate confirming it's a modern crafted piece, mostly as a courtesy to your own airport experience rather than a strict legal requirement."),
      faq(
        [
          {
            question: "Is it safe to buy antiques in Egypt?",
            answer: "No. Genuine antiquities can't legally be exported from Egypt, and anything offered to you as a real one either isn't genuine or is being sold illegally. Stick to modern crafts, which is what the overwhelming majority of the market actually sells anyway.",
          },
          {
            question: "How much should I expect to pay after negotiating?",
            answer: "There's no fixed formula, but opening with an offer around half the initial asking price is a normal starting point in most tourist-facing markets, with the final price landing somewhere between the two depending on the item and the seller.",
          },
          {
            question: "Are Khan el-Khalili's prices different from Luxor or Aswan's markets?",
            answer: "Generally, yes. Khan el-Khalili, as Cairo's most tourist-trafficked bazaar, tends to run higher than comparable markets in Luxor or Aswan, largely because of foot traffic and rent rather than any real difference in the goods.",
          },
          {
            question: "What's the single best souvenir if I only buy one thing?",
            answer: "For most travelers, a piece of hand-hammered copperware or a genuinely handwoven textile holds up best over time — both are distinctly Egyptian, durable, and something you'll actually use rather than store in a drawer.",
          },
        ],
        "Frequently Asked Questions"
      ),
      p("The best souvenirs from Egypt tend to be the ones tied to an actual craft — cotton grown along the Nile, copper hammered by hand in a Cairo workshop, alabaster carved from stone quarried not far from where it's sold. Buy less, buy carefully, and what you bring home will hold up a lot better than a suitcase filled with things bought just for the sake of buying something."),
      { _type: "ctaBlock", _key: nextBlockKey("cta"), title: "Shop Like You Know the Market", body: "Walk Khan el-Khalili with someone who knows which stalls are worth it and which aren't.", buttonLabel: "See the Walking Tour", buttonHref: "/tours/khan-el-khalili-food-walking-tour" },
    ],
  },
  {
    status: "published",
    ...
    relatedTours: toursBySlug("khan-el-khalili-food-walking-tour", "islamic-coptic-cairo-walking-tour", "aswan-nubian-village-philae-tour", "alexandria-day-trip"),
    seoTitle: "Best Markets & Bazaars in Egypt: A City-by-City Guide",
    seoDescription: "Egypt's best markets and bazaars, city by city — Khan el-Khalili in Cairo, the Aswan souk, Luxor's local markets, and Alexandria's antique trade.",
    body: [
      p("Egypt's markets aren't a single experience repeated in every city. Khan el-Khalili in Cairo, the covered souk in Aswan, and the smaller local markets in Luxor are genuinely different places, shaped by different histories and different everyday needs, and treating them as interchangeable stops on a shopping list misses most of what makes each one worth visiting. This is a market-by-market look at what's actually there, and what each one is genuinely good for beyond the souvenir shopping."),
      h2("Khan el-Khalili, Cairo"),
      p("Khan el-Khalili is Egypt's most famous bazaar for a reason — it's been a working commercial district since the 14th century, built around the tomb complex of a Mamluk emir, and it never really stopped being a real market even as it became a tourist landmark. The alleys are narrow and genuinely maze-like, opening into small workshops for goldsmiths, coppersmiths, and perfume blenders that have operated in the same spots for generations."),
      p("The market sits right beside Al-Hussein Mosque and the historic core of Islamic Cairo, so it's worth pairing a visit with a walk through the surrounding district rather than treating Khan el-Khalili as an isolated shopping stop. El Fishawy, a centuries-old coffeehouse tucked into one of the alleys, is a natural place to pause — it's been serving mint tea and coffee to shoppers and locals alike for longer than most buildings around it have stood, and sitting there for twenty minutes tells you as much about Cairo as an hour of walking does."),
      callout("Go in the late afternoon or early evening rather than midday. The light softens, the heat eases, and the market's shopfronts light up one by one — it's a genuinely different atmosphere from the same alleys at noon.", { title: "Best Time to Visit", tone: "Info" }),
      h2("The Aswan Souk"),
      p("Aswan's souk runs as a long, mostly covered market street a short walk from the Nile Corniche, and it feels noticeably less tourist-oriented than Khan el-Khalili, even with visitors passing through it every day. The product mix reflects the city itself — Aswan sits at Egypt's southern edge, close to the Nubian communities that give the city a genuinely different culture and history from Cairo or Luxor, and the souk carries that influence in its spice blends, basketry, and textiles."),
      p("Spice stalls here tend to be piled high and loosely organized rather than neatly packaged for tourists, and the vendors are generally used to being asked what something actually is and how it's used, rather than just how much it costs. It's also one of the better places in the country to find genuinely Nubian crafts — beadwork, woven baskets, and patterned textiles — rather than generic Egyptian souvenirs sold everywhere else."),
      h2("Luxor's Local Markets"),
      p("Luxor's markets are smaller and less polished than Cairo's or Aswan's, and that's exactly their appeal. Away from the main souvenir strip near the Nile, the everyday local market sells produce, spices, and household goods to Luxor residents first and tourists second, which makes for a more candid look at daily life than the more curated bazaars elsewhere. It's a good stop for anyone who wants a market experience without the more insistent sales pressure that comes with a market built primarily around tour groups."),
      p("The souvenir-facing stalls closer to the Nile corniche sell the expected mix of alabaster, papyrus, and scarves, generally at prices a notch below Cairo's, since Luxor sees fewer large tour groups moving through at once than Khan el-Khalili does."),
      h2("Attarine Market, Alexandria"),
      p("Alexandria's Attarine district has a genuinely different character from any of the markets further south — it's known for antiques and secondhand goods rather than crafts or spices, a legacy of the city's cosmopolitan past as a Mediterranean trading port. Furniture, old brassware, vintage clocks, and the occasional genuinely surprising find fill shopfronts that spill out onto the street. It rewards browsing more than shopping with a specific list in hand, and it's a natural stop to pair with the rest of an Alexandria day out — the city's Mediterranean waterfront, the Qaitbay Citadel, and the Graeco-Roman quarter all sit within a reasonable distance."),
      h2("Smaller Finds Worth Knowing About"),
      p("Tentmakers Street, tucked into the edge of Islamic Cairo near Bab Zuweila, is easy to miss and worth seeking out deliberately. It's a covered lane of workshops making khayamiya — the appliqué textile art traditionally used for tent linings and wedding canopies — sewn by hand in bold geometric and pharaonic patterns. Unlike most of the surrounding district, this is a craft still practiced by the same families who've done it for generations, and the finished pieces make genuinely distinctive wall hangings or cushion covers, quite different from anything sold in Khan el-Khalili proper."),
      p("Cairo's Gold Souk, a cluster of jewelry shops within Khan el-Khalili's broader footprint, is worth a separate mention too. Gold is typically sold by weight at a price tied to the day's market rate, with the workmanship added on top, which makes it one of the more transparent purchases in the entire bazaar if you ask the shop to explain the calculation before you buy."),
      h2("Getting the Most Out of Any Market"),
      ...bullets([
        "Go with time, not a checklist — the best moments in these markets tend to be the ones you weren't specifically looking for",
        "Bring small denominations of Egyptian pounds; not every stall can break a large note",
        "A local guide changes the experience considerably — not just for navigation, but for knowing which stalls are genuinely worth the stop and which are aimed purely at tour buses",
        "Late afternoon and early evening generally beat midday, both for temperature and atmosphere, in every market covered here",
      ]),
      h2("Which Market Fits Your Trip"),
      p("If Cairo is the only stop on the itinerary, Khan el-Khalili more than earns its reputation — it's simply one of the great historic bazaars anywhere, and pairing it with the surrounding Islamic Cairo district makes for a full afternoon rather than a quick shopping errand. If the trip includes Upper Egypt, the Aswan souk is worth deliberately setting aside time for rather than treating as a five-minute stop between temple visits; it's a meaningfully different market experience from Cairo's. And if Alexandria is on the route, even briefly, Attarine is worth a detour for anyone who genuinely enjoys browsing rather than shopping to a list."),
      p("None of these markets need to compete with each other on an itinerary — they're different enough in character that visiting more than one on a single trip never feels repetitive. A traveler who does Cairo and Luxor, or Cairo and Aswan, ends up seeing two genuinely different sides of how Egyptians shop, cook, and furnish their homes, which says as much about the country as any temple does."),
      faq(
        [
          {
            question: "Is Khan el-Khalili worth visiting if I'm short on time in Cairo?",
            answer: "Yes, even a short visit is worthwhile — it's one of the oldest working bazaars in the world, and even an hour spent walking the alleys and stopping for tea gives a real sense of the place, separate from whether you buy anything.",
          },
          {
            question: "Is the Aswan souk safe to walk through alone?",
            answer: "Generally yes, particularly during the day and early evening when it's busiest with both shoppers and vendors. As with any market, keep an eye on belongings in the more crowded stretches, the same common sense that applies to any busy market anywhere.",
          },
          {
            question: "Are prices fixed in these markets, or is everything negotiable?",
            answer: "Negotiation is the norm in nearly all of them, Khan el-Khalili and the Aswan souk included. Attarine's antique dealers in Alexandria also expect some back-and-forth, particularly on larger furniture pieces.",
          },
          {
            question: "What's the best market for genuinely local, non-touristy shopping?",
            answer: "Luxor's local produce and household-goods market and the deeper stretches of the Aswan souk both skew far more local than Khan el-Khalili's most tourist-facing alleys, which see the heaviest tour-group traffic in the country.",
          },
        ],
        "Frequently Asked Questions"
      ),
      p("Every one of these markets has been a working part of its city for generations, long before tourism turned any of them into a stop on an itinerary. Give them the time that history deserves, and they turn into one of the more memorable parts of an Egypt trip rather than a rushed errand between temples."),
      { _type: "ctaBlock", _key: nextBlockKey("cta"), title: "Walk the Real Khan el-Khalili", body: "See Cairo's oldest bazaar with a guide who knows which alleys and stalls are worth your time.", buttonLabel: "See the Walking Tour", buttonHref: "/tours/khan-el-khalili-food-walking-tour" },
    ],
  },
  {
    status: "published",
    ...
    author: editorialTeam,
    excerpt: "A handful of settings that hold up to the moment — a sunrise balloon over Luxor, a private felucca at sunset, Abu Simbel at dawn — and how to arrange each one so it actually goes the way you pictured it.",
    imageLabel: "Nile Felucca",
    imageTone: "nile",
    ...
    relatedTours: toursBySlug("hot-air-balloon-luxor-east-bank-combo", "cairo-felucca-sunset-sail", "aswan-abu-simbel-tour", "petra-by-night"),
    seoTitle: "Planning a Proposal in Egypt: Settings & Logistics",
    seoDescription: "Ideas for planning a proposal in Egypt — a sunrise hot air balloon over Luxor, a private felucca sail, Abu Simbel at dawn, and how to arrange each privately.",
    body: [
      p("Egypt gives a proposal something almost no other destination can: scale that makes the moment feel like it's happening inside history rather than in front of it. The trick isn't finding a beautiful location — Egypt has no shortage of those — it's picking a setting that can actually be arranged privately, at the right time of day, without thirty strangers wandering through the background of what should be a completely private moment. Here's what genuinely works, and how to think through arranging it."),
      h2("A Sunrise Hot Air Balloon Over Luxor"),
      p("Few settings anywhere match a hot air balloon over Luxor at sunrise. The West Bank spreads out below as the first light catches the Valley of the Kings, the Colossi of Memnon, and the Nile cutting through the green valley floor, with the desert beginning almost immediately beyond it. Baskets are usually shared with other passengers, so booking a private balloon, or at minimum confirming a small group, matters if the plan is a proposal rather than an audience. It's an early start — balloons fly at first light, when the air is calmest — but that's part of what makes it work: the whole basket is quiet, the temples are still catching their first color, and there's genuinely nowhere else that moment could happen."),
      h2("A Private Felucca at Sunset"),
      p("A felucca is Egypt's traditional wooden sailboat, and a private sunset sail is one of the simplest, most reliable settings to arrange well. No engine noise, no other passengers if it's chartered privately rather than shared, just the boat, the water, and the light changing over the Nile as the sun drops behind the skyline. In Cairo this usually means the river framed by the city; in Aswan or Luxor it means a quieter, more rural stretch of the Nile with feluccas drifting past and little else around. The setting works because it's unhurried by nature — there's no schedule pushing you along, which takes real pressure off getting the timing right."),
      callout("Chartering a felucca privately, rather than joining a shared sunset sail, is usually a modest cost difference and it removes the single biggest risk to a proposal on the water: strangers in every photo and an audience for the moment itself.", { title: "Book It Privately", tone: "Info" }),
      h2("Abu Simbel at First Light"),
      p("Abu Simbel is dramatic on any day, but it becomes something else entirely on the mornings of February 22 and October 22, when the temple was built to align so the rising sun reaches directly into the inner sanctuary and lights the statues at the very back. Even outside those two dates, arriving right at opening, before the tour buses from Aswan arrive in force, gives a version of the site that feels almost private, with the colossal facade catching the low morning sun. Abu Simbel sits roughly a flight or a long desert drive from Aswan, so this one takes more planning than the others, but for a couple willing to build a full day around it, the payoff is one of the most singular backdrops in the country."),
      h2("The Giza Plateau, Away From the Crowds"),
      p("The Pyramids are the single most recognizable backdrop in Egypt, and while the plateau is genuinely crowded through the middle of the day, both very early morning and the hour before closing thin the crowds substantially. A quieter viewpoint away from the main tourist cluster, timed for softer light, turns a site most people associate with crowds and camera-phone chaos into something that actually feels intimate. Egypt Eye arranges a dedicated proposal setup at the Pyramids for exactly this reason — a private, photographed moment against one of the most photographed monuments on Earth, without the crowd that normally comes with it."),
      h2("A Private Dahabiya on the Nile"),
      p("For a proposal built around more than a single moment, a few nights on a dahabiya — a small, traditionally styled sailboat carrying only a handful of cabins — turns the entire cruise into the setting rather than one afternoon of it. Unlike a large multi-deck cruise ship, a dahabiya sails partly under wind power and moves at a genuinely slower pace between Luxor and Aswan, mooring at quiet riverbank stops that bigger ships skip entirely. It suits couples who'd rather propose somewhere unhurried and private than at a single dramatic set piece, with the whole boat effectively private if booked for just the two of you or a small group."),
      h2("Petra by Night, If the Trip Extends Into Jordan"),
      p("For couples combining Egypt with Jordan, Petra by Night offers a setting nothing in Egypt quite replicates. The mile-long Siq leading into the ancient city is lit entirely by candles for the walk in, opening onto the Treasury facade glowing in candlelight against the desert dark. It runs as a shared evening rather than a private booking, so it's better suited to a quieter, more understated proposal than a fully choreographed one — but the atmosphere alone does most of the work."),
      h2("Getting the Logistics Right"),
      p("Whatever the setting, arranging it privately — a chartered felucca rather than a shared boat, a small or private hot air balloon rather than a full public flight, an early or after-hours slot at a major site — matters more to how the moment actually feels than the specific location does. A few practical points worth sorting out well before the trip:"),
      ...bullets([
        "Ring transport: keep it in carry-on luggage, never checked, and consider a discreet travel case rather than the original box",
        "Timing flexibility: hot air balloons and some site access depend on weather and operating hours, so build at least one buffer day around the planned moment if the whole trip hinges on it",
        "Photography: arranging a photographer in advance, rather than relying on a phone held by whoever's nearby, means the moment is actually documented rather than half-captured after the fact",
        "Privacy first, so tell whoever is arranging the trip, in plain terms, exactly what you want kept just between the two of you, and who — if anyone — should be in on it",
      ]),
      h2("Timing It With the Rest of the Trip"),
      p("Most couples plan the proposal for early in the trip rather than the end, so the rest of the journey becomes the celebration rather than the lead-up. A sunrise balloon on day two of a Luxor stop, for instance, leaves the following days in Aswan or on a Nile cruise as a genuinely joyful stretch of the trip rather than an anticlimax after the main event. There's no wrong order, but it's worth deciding on purpose rather than defaulting to the last night simply because that's the traditional move. If it happens early, it's also worth briefing whoever is arranging the itinerary so the remaining days can lean into the celebration — a nicer dinner, a better room, a slower pace — rather than continuing exactly as originally planned."),
      faq(
        [
          {
            question: "Is a hot air balloon proposal in Luxor really private?",
            answer: "Only if you book it that way. Standard balloon flights carry other passengers in the same basket, so a private or small-group charter is what actually secures the moment — worth confirming directly rather than assuming.",
          },
          {
            question: "What's the best time of year for an Abu Simbel proposal?",
            answer: "The temple is striking year-round, but February 22 and October 22 — the solar alignment dates when sunlight reaches the inner sanctuary — add genuine significance for anyone drawn to that kind of detail. Outside those dates, arriving right at opening still beats the midday crowds.",
          },
          {
            question: "Can a proposal be arranged at the Pyramids specifically?",
            answer: "Yes — a private, photographed proposal setup at the Giza plateau is one of Egypt Eye's dedicated experiences, timed for softer light and a quieter corner of the plateau away from the main crowds.",
          },
          {
            question: "Should we tell our tour guide or photographer about the plan in advance?",
            answer: "Generally yes. Guides and photographers who know what's coming can help with timing, positioning, and keeping other visitors out of frame — all things that are much harder to arrange in the moment itself.",
          },
        ],
        "Frequently Asked Questions"
      ),
      p("The setting matters, but it's the privacy and the timing that actually make a proposal in Egypt feel the way it does in imagination rather than in a crowd of tourists checking their phones. Pick a backdrop that means something to the two of you, arrange it so it's genuinely private, and let a country with three thousand years of history do the rest of the work."),
      { _type: "ctaBlock", _key: nextBlockKey("cta"), title: "Plan Your Proposal in Egypt", body: "From a private hot air balloon to a photographed moment at the Pyramids, we'll help you build the setting around the moment.", buttonLabel: "Start Planning", buttonHref: "/customize" },
    ],
  },
  {
    status: "published",
    ...
    author: editorialTeam,
    excerpt: "Cabin size, cruise length, ship type, and the one factor that matters more than any of them — a practical guide to choosing between Luxor and Aswan.",
    imageLabel: "Nile Valley",
    imageTone: "nile",
    ...
    relatedTours: toursBySlug("4-day-nile-cruise-luxor-aswan", "7-night-nile-cruise-luxor-aswan", "private-yacht-nile-cruise-luxor-aswan", "overnight-dahabiya-sail-esna-edfu"),
    seoTitle: "How to Choose a Nile Cruise Ship: A Practical Guide",
    seoDescription: "What actually matters when choosing a Nile cruise — cruise length, cabin position, ship type, and private versus shared-group excursions ashore.",
    body: [
      p("Every Nile cruise between Luxor and Aswan visits roughly the same handful of temples — that part of the itinerary is largely fixed by geography. What varies enormously is the boat itself, and that variation ends up shaping the trip far more than most people expect going in. A cramped lower-deck cabin on a crowded standard cruiser and a quiet balcony cabin on a smaller ship can produce two completely different experiences of the same four days on the same stretch of river. Here's what to actually weigh before booking."),
      h2("How Long to Cruise"),
      p("The standard options run 4 nights or 7 nights between Luxor and Aswan, sailing in either direction depending on the specific itinerary. A 4-night cruise covers the core stops — Edfu, Kom Ombo, and the sail itself — at a comfortable but efficient pace, and suits travelers who want the Nile cruise as one strong chapter within a broader Egypt trip rather than the entire focus of it. A 7-night cruise adds room to slow down considerably, with more time at anchor, more flexibility around each stop's timing, and generally fewer early mornings squeezed back to back."),
      p("Longer isn't automatically better — it depends on how much of the trip's total time budget a cruise should reasonably take up. For a first trip to Egypt that also needs to cover Cairo and Giza properly, a 4-night cruise often makes more sense logistically. For a trip built specifically around the Nile itself, the extra nights are genuinely worth it."),
      h2("Ship Size and Type"),
      p("Standard Nile cruise ships carry anywhere from several dozen to well over a hundred passengers across multiple decks, with the usual amenities — a pool deck, a dining room, a lounge — built for a larger group. They're comfortable and predictable, but shore excursions from a large ship are often organized in equally large groups, which changes the pace of every stop from a temple visit into something closer to crowd management."),
      p("A dahabiya sits at the other end of the spectrum entirely — a small, traditionally styled sailboat carrying only a handful of cabins, moving partly under wind power rather than a full-time engine. It's a genuinely slower, quieter way to travel the same stretch of river, mooring at riverbank spots the bigger ships skip, with every meal and excursion built around a small group rather than a boatload of strangers. A private yacht charter goes further still, giving over the entire vessel to one traveling party."),
      callout("A dahabiya's slower pace comes with a tradeoff worth knowing in advance: fewer onboard amenities than a full-size cruise ship, and an itinerary more dependent on wind and river conditions than a diesel-powered ship's fixed schedule. For travelers who want that particular kind of unhurried trip, it's a fair exchange. For travelers who want a pool deck and a full spa, it isn't the right choice.", { title: "Know the Tradeoff", tone: "Info" }),
      h2("Cabin Position"),
      p("On a standard multi-deck cruiser, cabin position affects the trip more than most first-time bookers realize. Lower decks sit closer to the engine and feel more of its vibration and noise, particularly overnight while the ship is actually sailing between stops. Higher decks are quieter and often come with a private balcony, at a meaningful cost premium over a standard lower-deck cabin — a premium that's usually worth paying if the budget allows, especially for a longer cruise where you'll spend more nights aboard."),
      h2("Private Guides vs. Group Excursions"),
      p("This is the single factor that affects trip satisfaction most, more than the ship itself. Many standard cruises handle shore excursions as a single large group, bused together from the ship to each temple and walked through on a fixed schedule set by the group's slowest common denominator. A private guide, arranged either through the cruise itself or separately, removes that constraint entirely — you set your own pace at Edfu or Kom Ombo, linger where something catches your attention, and skip what doesn't, regardless of which boat you're sleeping on at night."),
      ...bullets([
        "Ask directly, before booking, whether shore excursions are private or shared, and how large the shared groups typically run",
        "Confirm whether an Egyptologist guide is included or arranged as an add-on — the quality of that guide affects the temples far more than the ship's amenities do",
        "Check which stops are included by default (Edfu and Kom Ombo are standard on most itineraries) versus offered as optional extras",
        "Ask about the Esna lock — most Luxor–Aswan cruises pass through it, and timing can affect the overall schedule by a few hours depending on lock traffic",
      ]),
      h2("Dining and Onboard Life"),
      p("Most standard cruises operate on a set meal schedule with buffet-style dining included in the fare, which works fine but rarely stands out as a highlight. Smaller ships and dahabiyas tend to serve meals more like a proper dinner, often prepared for the specific group aboard rather than a large buffet line, which becomes one of the quieter pleasures of the smaller-boat experience rather than an afterthought between excursions."),
      h2("Sailing North or South"),
      p("Cruises run in both directions between Luxor and Aswan, and the choice mostly comes down to how the rest of the trip is structured rather than any real difference in the onboard experience. Starting in Luxor and sailing south to Aswan means beginning with the East and West Bank temples before the cruise, then finishing in Aswan, which pairs naturally with a side trip to Abu Simbel at the end. Starting in Aswan and sailing north to Luxor reverses that, opening with Abu Simbel and the High Dam before the boat sets off, and closing the trip in Luxor. Neither direction has a real advantage on the water itself — the temples along the way are the same regardless of which way the boat is pointed — so let flight logistics and the rest of the itinerary decide it."),
      h2("What's Usually Included"),
      p("Meals, the cabin, and transit through the standard stops are included in almost every Nile cruise fare, but the details worth confirming before booking are what sits outside that baseline: whether an Egyptologist guide is included or billed separately, whether entrance fees to the temples themselves are bundled into the price, and whether excursions like a hot air balloon in Luxor or the Abu Simbel add-on from Aswan are part of the package or booked on top. None of these are dealbreakers either way, but knowing the actual scope of what's included avoids surprises once the cruise is underway and options start getting offered onboard at a markup."),
      h2("When to Book"),
      p("Nile cruises run year-round, but the cooler months from November through February are the most popular, which means the better cabins on both standard ships and dahabiyas book up first. If a specific cabin position or a dahabiya with only a handful of berths is the priority, booking well ahead of a winter trip matters considerably more than it would for a summer sailing, when availability is generally looser."),
      faq(
        [
          {
            question: "Is a dahabiya more expensive than a standard Nile cruise ship?",
            answer: "Generally yes, given the smaller passenger count over which costs are spread and the more personalized service, though it varies by specific boat and season. It's a different kind of trip more than simply a pricier version of the same one.",
          },
          {
            question: "How many nights on the Nile is enough?",
            answer: "4 nights covers the core route and stops comfortably for most travelers; 7 nights suits anyone who wants the cruise itself, rather than the destinations at either end, to be the centerpiece of the trip.",
          },
          {
            question: "Do all Nile cruises stop at the same temples?",
            answer: "Most standard itineraries include Edfu and Kom Ombo as a matter of course, since they sit directly on the route between Luxor and Aswan. Beyond that, specific stops and their duration vary by cruise, so it's worth checking the exact itinerary rather than assuming.",
          },
          {
            question: "Is a lower-deck cabin worth the savings?",
            answer: "For a shorter cruise, it's a reasonable tradeoff for most travelers. For a longer sailing, or for anyone sensitive to engine noise and vibration overnight, the upgrade to a higher deck or a balcony cabin tends to be worth the difference.",
          },
        ],
        "Frequently Asked Questions"
      ),
      p("There's no single right answer between a standard cruise ship, a dahabiya, and a private yacht — each suits a different kind of traveler and a different kind of trip. What matters is choosing deliberately, based on pace and privacy rather than the ship's marketing photos, and confirming exactly how the shore excursions are run before you book. Get that part right, and almost any boat on the Nile delivers the trip you're picturing."),
      { _type: "ctaBlock", _key: nextBlockKey("cta"), title: "Find the Right Nile Cruise", body: "From a 4-night sailing to a private dahabiya, we'll help you pick the boat that matches how you want to travel.", buttonLabel: "Explore Nile Cruises", buttonHref: "/tours/4-day-nile-cruise-luxor-aswan" },
    ],
  },
  {
    status: "published",
    ...
    relatedTours: toursBySlug("8-day-essential-egypt-nile-cruise", "hurghada-red-sea-diving-snorkeling", "6-day-cairo-giza-luxor", "sharm-el-sheikh-day-trip-from-cairo"),
    seoTitle: "Weather in Egypt by Month: When to Plan Your Trip",
    seoDescription: "A month-by-month breakdown of Egypt's weather in Cairo, Luxor, Aswan, and the Red Sea coast, to help you time a trip around comfortable temperatures.",
    body: [
      p("Egypt doesn't have a single climate. Cairo, Upper Egypt, and the Red Sea coast each run on their own temperature curve through the year, and a month that's ideal for one region can be uncomfortably hot, or surprisingly cold at night, in another. This is a practical, region-aware breakdown of what to actually expect, month by month, so the timing of a trip matches what you actually want to be doing once you're there."),
      h2("Understanding Egypt's Regions"),
      p("Cairo and the Nile Delta sit in a temperate zone that swings noticeably between winter and summer. Upper Egypt — Luxor and Aswan — is desert climate proper, with far hotter summers and a wider gap between daytime and nighttime temperatures than Cairo sees. The Red Sea coast, from Hurghada down to Marsa Alam and across to Sharm El Sheikh and Dahab in Sinai, is moderated by the sea itself, staying more temperate through summer and warmer through winter nights than the desert interior. Keeping these three zones separate in your head, rather than thinking of \"Egypt weather\" as one number, is the single most useful thing to know before choosing when to go."),
      h2("November Through February: The Coolest Window"),
      p("This is the most popular season for sightseeing, and for good reason. Cairo and Luxor both settle into genuinely comfortable daytime temperatures, cool enough for a full day of walking around temples without the heat becoming the story of the trip, with cool evenings that often call for a light jacket, especially in Upper Egypt after sunset. Desert nights in particular can turn surprisingly cold — a clear sky over the Sahara loses heat fast once the sun goes down, so a stop in the White Desert or Siwa during these months means packing warmer layers than the daytime heat would suggest."),
      p("The Red Sea coast stays swimmable throughout this window, though the water runs noticeably cooler than in summer, and a wetsuit is worth considering for snorkeling or diving trips in January and February specifically. Because this is peak season, popular sites and better hotel rooms book up further in advance than in the shoulder months."),
      h2("March Through May: Warming Up"),
      p("Temperatures climb steadily through this stretch, and most of it stays comfortable for sightseeing, particularly March and April. Late May is where the shift becomes real, especially in Luxor and Aswan, where daytime heat starts pushing into the range that makes midday temple visits genuinely draining rather than merely warm. This is a good window for travelers who want warmer days without full summer heat, and it tends to be less crowded than the November–February peak."),
      h2("June Through August: Peak Heat in the Nile Valley"),
      p("Summer in Cairo and Upper Egypt is genuinely hot, with Luxor and Aswan regularly climbing well above 38°C (100°F) during the day. It's not an impossible season to visit — early starts, indoor breaks during the hottest midday hours, and pacing sightseeing around the heat all make it manageable — but it demands more deliberate planning than a winter trip does. This is, by contrast, the strongest season for the Red Sea coast, where sea breezes soften the heat considerably compared to the desert interior, making Hurghada, Sharm El Sheikh, and Dahab genuinely pleasant even in August."),
      callout("If a summer trip is unavoidable, structure the day around the heat rather than fighting it: an early start at major sites before 9 AM, an indoor or air-conditioned break through the early afternoon, and outdoor activity again once the heat breaks in the late afternoon or evening. Hydration matters more here than in almost any other part of a trip's logistics.", { title: "Traveling in Summer Heat", tone: "Safety" }),
      h2("September and October: The Second Shoulder Season"),
      p("Temperatures begin easing through September, and October in particular has become a favored shoulder-season window among experienced Egypt travelers — warm enough for the Red Sea, no longer extreme in Luxor and Aswan, and generally less crowded than the November–February peak while still delivering comfortable sightseeing conditions. For travelers trying to balance good weather against crowds and pricing, October is often the best-kept secret on the calendar."),
      h2("Matching the Month to the Trip"),
      ...bullets([
        "Nile cruise or full Cairo-to-Aswan itinerary: November through February for the most comfortable temple-hopping, or October as a quieter, slightly warmer alternative",
        "Red Sea diving or beach time: June through August for the warmest water and liveliest coastal atmosphere, though the coast is genuinely pleasant nearly year-round",
        "Desert trips (White Desert, Siwa, Western Desert oases): November through March for manageable daytime heat, with warm layers packed for cold desert nights regardless of month",
        "Photography and golden-hour shooting: winter's lower sun angle and clearer air generally produce the most dramatic light across the Nile Valley",
      ]),
      h2("Cairo vs. Luxor vs. the Red Sea, at a Glance"),
      p("Cairo's climate is the mildest of the three through most of the year — genuinely cold snaps are rare, genuinely extreme heat is limited mostly to the peak of summer, and its position near the Mediterranean moderates both ends of the scale compared to Upper Egypt. Luxor and Aswan run hotter in summer and colder at night in winter than Cairo does, the classic desert pattern of a wide daily temperature swing rather than a mild, even climate. The Red Sea coast is the outlier in a good way: the sea keeps both summer highs and winter lows more temperate than the desert interior, which is exactly why it functions as a nearly year-round destination in a way Luxor and Aswan don't."),
      p("That contrast is worth building directly into a multi-region itinerary. A trip that runs Cairo, then Luxor and Aswan, then finishes on the Red Sea coast can lean into each region's strongest season rather than fighting the weather in any one of them — sightseeing in the cooler months inland, then unwinding by the sea where the temperature is far more forgiving even outside peak season."),
      h2("What to Pack, Regardless of Season"),
      p("Layers matter in every season in Egypt, not just winter. Desert nights stay cool even in summer, air-conditioned interiors (museums, cars, hotel lobbies) can feel sharply cold after a hot street, and mornings on a Nile cruise or a sunrise hot air balloon are cool even in July. Sun protection is non-negotiable year-round — Egypt's sun is intense even on a mild winter afternoon, and modest, breathable clothing works better for both comfort and cultural fit than what a beach-only trip elsewhere might call for."),
      faq(
        [
          {
            question: "What's the single best month to visit Egypt?",
            answer: "October and February both make strong cases — comfortable temperatures across Cairo and Upper Egypt, swimmable Red Sea water, and generally more availability than the peak December–January stretch.",
          },
          {
            question: "Is summer too hot to visit Luxor and Aswan?",
            answer: "It's genuinely hot, often above 38°C (100°F), but not unmanageable with the right pacing — early starts, midday breaks, and evening activity. Many travelers do visit successfully in summer; it simply requires more deliberate scheduling than a winter trip.",
          },
          {
            question: "Does it ever rain in Egypt?",
            answer: "Rarely, and almost never in Upper Egypt or the Red Sea coast. Cairo and Alexandria see occasional light winter rain, but it's uncommon enough that it shouldn't factor meaningfully into trip planning.",
          },
          {
            question: "Is the Red Sea warm enough to swim in winter?",
            answer: "Yes, though the water runs noticeably cooler than summer. Most people find it comfortable for swimming; a wetsuit is worth considering for longer snorkeling or diving sessions in January and February specifically.",
          },
          {
            question: "Should I plan a Nile cruise and a Red Sea extension for the same month?",
            answer: "It works well nearly any time of year, since the Red Sea coast stays pleasant even outside its peak summer season. Winter is the one exception worth noting — the water is swimmable but distinctly cooler, so anyone planning serious snorkeling or diving time might prefer to weight the trip toward the warmer months instead.",
          },
        ],
        "Frequently Asked Questions"
      ),
      p("There isn't a genuinely bad month to visit Egypt, only months better suited to different kinds of trips. Match the season to what you actually want to be doing — temple-hopping, diving, desert camping, or some combination — and the weather stops being a variable to worry about and starts working in your favor."),
      { _type: "ctaBlock", _key: nextBlockKey("cta"), title: "Plan Your Trip Around the Right Season", body: "Tell us when you're traveling and we'll build an itinerary that matches Egypt's weather to what you want to do.", buttonLabel: "Start Planning", buttonHref: "/customize" },
    ],
  },
  {
    status: "published",
    ...
    author: editorialTeam,
    excerpt: "The logistics of visiting both countries on one trip — flight connections, how much time each side realistically needs, and how to sequence a route that actually flows.",
    imageLabel: "Petra Treasury",
    imageTone: "jordan",
    ...
    relatedTours: toursBySlug("9-day-egypt-jordan-combo", "14-day-egypt-jordan-classic-journey", "jordan-5-day-highlights", "petra-by-night"),
    seoTitle: "Combining Egypt and Jordan: How to Plan the Trip",
    seoDescription: "How to plan a combined Egypt and Jordan trip — flight connections, how many days each country needs, visa basics, and a suggested route.",
    body: [
      p("Egypt and Jordan sit close enough together, and differ enough from each other, that combining them on one trip makes more sense than almost any other two-country pairing in the region. Cairo and Amman are a short flight apart, the pyramids and Petra rarely appear on the same itinerary even though they're neighbors, and travelers already crossing several time zones to reach one country are usually glad to have made the effort worth it by seeing both. This is a practical look at how to actually structure that trip — timing, sequencing, and how much each side genuinely needs."),
      h2("The Flight Connection"),
      p("Cairo and Amman are connected by a short direct flight, under two hours in the air, which is what makes this pairing so much more practical than it first appears on a map. It's a far easier connection than most travelers expect, closer to a domestic hop than an international transfer, and it means the two countries can realistically sit inside one continuous trip rather than requiring two entirely separate visits years apart."),
      h2("How Much Time Each Side Needs"),
      p("Egypt is the larger country to cover, and it rewards more time — a minimum of 5 to 6 days covers Cairo, Giza, and a Luxor stop without feeling rushed, though that's a tight version of the trip. Add a Nile cruise between Luxor and Aswan, or a Red Sea extension, and Egypt alone comfortably fills 9 to 12 days. Jordan is more compact: 3 to 4 days covers Amman, Petra, and Wadi Rum at a comfortable pace, with an extra day worth adding for the Dead Sea if floating in it matters to you."),
      ...bullets([
        "A tighter combined trip: roughly 9 days total, split as 5-6 in Egypt (Cairo, Giza, and either Luxor or a short Nile cruise) and 3-4 in Jordan (Amman, Petra, Wadi Rum)",
        "A fuller combined trip: 12-14 days, giving Egypt its full arc — Cairo, Luxor, Aswan, and a Nile cruise — alongside a complete Jordan leg that adds the Dead Sea",
        "A shorter Jordan-only add-on to an Egypt-focused trip: 3 days is enough for Petra and Wadi Rum specifically, if Amman and the Dead Sea aren't priorities",
      ]),
      h2("Which Order to Run It"),
      p("Most combined itineraries run Egypt first, ending the Egypt leg in Luxor or Cairo before flying to Amman for the Jordan portion — though the order works equally well reversed, and the right choice usually comes down to international flight connections rather than any inherent advantage to either sequence. If your international flights route more naturally through Amman, starting in Jordan and finishing in Egypt makes sense; if Cairo is the more convenient entry point, starting there does."),
      p("One sequencing detail worth thinking through deliberately: Egypt's pace, especially with a Nile cruise involved, tends to be more scheduled and itinerary-driven, with early starts for temple visits and set excursion times. Jordan, especially the Wadi Rum stretch, has a slower, more open feel. Some travelers prefer ending on that slower note, using Jordan as a wind-down after a busier Egypt leg; others prefer the reverse, treating Jordan's more compact sights as a warm-up before Egypt's bigger, more demanding itinerary. Neither is wrong — it's a matter of which rhythm you'd rather close the trip on."),
      h2("What Each Country Contributes"),
      p("Egypt brings the ancient monuments at a scale nothing else matches — the Pyramids of Giza, the temples of Luxor, a Nile cruise past millennia of history along the riverbank. Jordan brings Petra, which stands entirely on its own as one of the great archaeological sites anywhere, plus Wadi Rum's desert landscape, the otherworldly float in the Dead Sea, and Amman's own layered history as a working capital city. The two experiences don't overlap or compete with each other, which is part of why the combination works so well rather than feeling repetitive."),
      callout("Petra by Night — the walk into the ancient city along a mile-long, candlelit path, ending at the Treasury glowing in the dark — is worth deliberately scheduling in advance rather than treating as a spontaneous add-on. It doesn't run every night of the week, so check the schedule against your Jordan dates early in the planning process.", { title: "Don't Miss Petra by Night", tone: "Highlight" }),
      h2("A Sample 12-Day Route"),
      p("There's no single correct way to sequence this trip, but a route that gives both countries a fair amount of time without feeling rushed generally looks something like this: a few days in Cairo and Giza to open the trip, a flight to Luxor for the East and West Bank temples, a short Nile cruise or a direct flight down to Aswan, then the international connection to Amman. From there, a day in Amman itself, two full days for Petra (one is enough to see it, but a second lets you go back in at a different time of day, or simply walk further than the standard route), and a night or two in Wadi Rum's desert camps before finishing with the Dead Sea on the way back to the airport."),
      p("That structure isn't the only option — plenty of travelers skip Amman almost entirely and head straight to Petra and Wadi Rum, or add extra Nile cruise nights and trim Jordan to Petra and Wadi Rum alone. The point of laying it out this way isn't to prescribe a fixed itinerary, it's to show how naturally the pieces click together once flight timing is treated as the organizing constraint rather than an afterthought."),
      h2("Visas and Border Basics"),
      p("Both countries require a visa for most nationalities, arranged either on arrival or in advance depending on your passport, and the requirements are handled separately by each country rather than through any shared arrangement — there's no single visa covering both. It's worth checking the current requirement for your specific nationality well before the trip rather than assuming, since policies do shift over time and a same-day scramble at the airport is not where you want to discover a gap."),
      h2("Currency and Practical Logistics"),
      p("Egypt and Jordan use separate currencies — the Egyptian pound and the Jordanian dinar — and neither is easy to exchange for outside their home country, so plan to withdraw or exchange currency after arrival in each rather than carrying one country's cash into the other. Time zones are close enough (typically an hour apart) that jet lag isn't a real factor moving between them, which is one more reason the combination works more smoothly than it might on paper."),
      p("Packing for both legs at once is simpler than it sounds, since the two countries share a similar climate profile for much of the year — hot days, cool desert nights, and a genuine need for sun protection and modest, breathable clothing in both. The main adjustment between legs is footwear: Petra involves a fair amount of walking on uneven stone, and Wadi Rum's desert camps mean sand underfoot, so comfortable closed shoes earn their space in the suitcase more in Jordan than they might for a Nile cruise-heavy Egypt itinerary."),
      faq(
        [
          {
            question: "How long is the flight between Cairo and Amman?",
            answer: "Under two hours, making it one of the more convenient international connections in the region — closer in feel to a short regional hop than a major international transfer.",
          },
          {
            question: "Should I do Egypt or Jordan first?",
            answer: "Either order works well. Let your international flight connections decide, and consider whether you'd rather open the trip with Jordan's more compact pace or close on it as a slower wind-down after a busier Egypt itinerary.",
          },
          {
            question: "Can I see both countries properly in under two weeks?",
            answer: "Yes — a 9-day combined trip covers a solid version of both, with 5-6 days in Egypt and 3-4 in Jordan. Extending toward 12-14 days allows a fuller Egypt itinerary, including a Nile cruise, without shortchanging Jordan.",
          },
          {
            question: "Do I need separate visas for Egypt and Jordan?",
            answer: "Yes, the two countries handle entry requirements independently, so check the current visa policy for your nationality for each country separately well before the trip.",
          },
          {
            question: "Is Petra worth visiting if I've already seen Egypt's temples?",
            answer: "Very much so. Petra is a different kind of ancient site entirely — carved directly into rose-colored rock rather than built up from stone blocks — and it doesn't feel repetitive alongside Egypt's monuments in the way two similar sites might.",
          },
        ],
        "Frequently Asked Questions"
      ),
