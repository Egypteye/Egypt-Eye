        ...
        <div className="relative grid gap-10 p-8 sm:p-12 lg:grid-cols-[1.05fr_1fr] lg:items-center lg:gap-14 lg:p-16">
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-5">
              <Link
                href="/explore-egypt"
                className="group/cta inline-flex items-center gap-3 rounded-full bg-gold py-2 pl-6 pr-2 text-sm font-semibold text-ink shadow-lg shadow-gold/20 transition-all duration-500 [transition-timing-function:cubic-bezier(0.32,0.72,0,1)] hover:bg-gold-light hover:shadow-xl hover:shadow-gold/30 active:scale-[0.98]"><T>Start Exploring</T><span className="flex h-8 w-8 items-center justify-center rounded-full bg-ink text-cream transition-transform duration-500 [transition-timing-function:cubic-bezier(0.32,0.72,0,1)] group-hover/cta:translate-x-0.5 group-hover/cta:-translate-y-0.5">
